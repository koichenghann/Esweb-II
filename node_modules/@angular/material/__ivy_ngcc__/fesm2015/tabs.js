...
function MatTabGroup_div_2_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const tab_r4521 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("cdkPortalOutlet", tab_r4521.templateLabel);
} }
function MatTabGroup_div_2_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const tab_r4521 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵtextInterpolate(tab_r4521.textLabel);
} }
function MatTabGroup_div_2_Template(rf, ctx) { if (rf & 1) {
    const _r4529 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 6);
    ɵngcc0.ɵɵlistener("click", function MatTabGroup_div_2_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r4529); const tab_r4521 = ctx.$implicit; const i_r4522 = ctx.index; const ctx_r4528 = ɵngcc0.ɵɵnextContext(); const _r4517 = ɵngcc0.ɵɵreference(1); return ctx_r4528._handleClick(tab_r4521, _r4517, i_r4522); });
    ...
    const tab_r4521 = ctx.$implicit;
    const i_r4522 = ctx.index;
    const ctx_r4518 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassProp("mat-tab-label-active", ctx_r4518.selectedIndex == i_r4522);
    ɵngcc0.ɵɵproperty("id", ctx_r4518._getTabLabelId(i_r4522))("disabled", tab_r4521.disabled)("matRippleDisabled", tab_r4521.disabled || ctx_r4518.disableRipple);
    ɵngcc0.ɵɵattribute("tabIndex", ctx_r4518._getTabIndex(tab_r4521, i_r4522))("aria-posinset", i_r4522 + 1)("aria-setsize", ctx_r4518._tabs.length)("aria-controls", ctx_r4518._getTabContentId(i_r4522))("aria-selected", ctx_r4518.selectedIndex == i_r4522)("aria-label", tab_r4521.ariaLabel || null)("aria-labelledby", !tab_r4521.ariaLabel && tab_r4521.ariaLabelledby ? tab_r4521.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", tab_r4521.templateLabel);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !tab_r4521.templateLabel);
} }
function MatTabGroup_mat_tab_body_5_Template(rf, ctx) { if (rf & 1) {
    const _r4533 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "mat-tab-body", 10);
    ɵngcc0.ɵɵlistener("_onCentered", function MatTabGroup_mat_tab_body_5_Template_mat_tab_body__onCentered_0_listener() { ɵngcc0.ɵɵrestoreView(_r4533); const ctx_r4532 = ɵngcc0.ɵɵnextContext(); return ctx_r4532._removeTabBodyWrapperHeight(); })("_onCentering", function MatTabGroup_mat_tab_body_5_Template_mat_tab_body__onCentering_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r4533); const ctx_r4534 = ɵngcc0.ɵɵnextContext(); return ctx_r4534._setTabBodyWrapperHeight($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const tab_r4530 = ctx.$implicit;
    const i_r4531 = ctx.index;
    const ctx_r4520 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassProp("mat-tab-body-active", ctx_r4520.selectedIndex == i_r4531);
    ɵngcc0.ɵɵproperty("id", ctx_r4520._getTabContentId(i_r4531))("content", tab_r4530.content)("position", tab_r4530.position)("origin", tab_r4530.origin)("animationDuration", ctx_r4520.animationDuration);
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r4520._getTabLabelId(i_r4531));
} }
